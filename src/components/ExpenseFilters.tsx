...
export function ExpenseFilters({ filters, categories, onFiltersChange }: ExpenseFiltersProps) {
  ...
  const hasActiveFilters = filters.dateFrom || filters.dateTo || filters.category || filters.searchText;
